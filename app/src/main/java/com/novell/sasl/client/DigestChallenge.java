...
class DigestChallenge extends Object
{
     ...
     *
     * @exception org.apache.harmony.javax.security.sasl.SaslException   If a semantic error occurs
     */
    void checkSemantics(
     ...
     *
     * @exception org.apache.harmony.javax.security.sasl.SaslException   If an error occurs due to too many nonce
     *                             values
     */
    void handleNonce(
     ...
     * @param      pd   ParsedDirective
     *
     * @exception org.apache.harmony.javax.security.sasl.SaslException   If an error occurs due to too many qop
     *                             directives
     */
    void handleQop(
        ParsedDirective  pd) throws SaslException
     ...
     * @param      pd   ParsedDirective
     *
     * @exception org.apache.harmony.javax.security.sasl.SaslException If an error occur
     */
    void handleMaxbuf(
        ParsedDirective  pd) throws SaslException
    {
     ...
     * @param      pd   ParsedDirective
     *
     * @exception org.apache.harmony.javax.security.sasl.SaslException If an error occurs dur to too many charset
     ...
     * @param      pd   ParsedDirective
     *
     * @exception org.apache.harmony.javax.security.sasl.SaslException If an error occurs due to too many algorith
     ...
     * @param      pd   ParsedDirective
     *
     * @exception org.apache.harmony.javax.security.sasl.SaslException If an error occurs due to Too many cipher
     *                           directives
     */
    void handleCipher(
        ParsedDirective  pd) throws SaslException
     ...
     * @param      pd   ParsedDirective
     *
     * @exception org.apache.harmony.javax.security.sasl.SaslException If an error occurs due to Too many stale
