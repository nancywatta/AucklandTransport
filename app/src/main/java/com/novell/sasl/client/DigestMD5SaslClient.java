...
public class DigestMD5SaslClient implements SaslClient
{
     ...
     *
     * @exception org.apache.harmony.javax.security.sasl.SaslException  If a SaslClient instance cannot be created
     *                     because of an error
     */
     ...
     *
     * @exception org.apache.harmony.javax.security.sasl.SaslException  if incoming cannot be successfully unwrapped.
     *
     ...
     *
     * @exception org.apache.harmony.javax.security.sasl.SaslException  if a problem was encountered while disposing
     *                           of the resources
     */
    public void dispose()
            throws SaslException
     ...
     *
     * @exception org.apache.harmony.javax.security.sasl.SaslException   If an error occurred while processing the
     ...
     *
     * @exception org.apache.harmony.javax.security.sasl.SaslException  If an error occurs
     */
    char[] DigestCalcHA1(
        String   algorithm,
        String   userName,
