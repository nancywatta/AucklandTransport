...
/**
 * ManageRoute class is used to provide the detailed
 * information on the route selected by the user.
 *
 * Created by Nancy on 7/15/14.
 */
public class ManageRoute extends ActionBarActivity implements
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.manage_route, menu);
...
//                    return getString(R.string.title_section2).toUpperCase(l);
    ...
    public static class PlaceholderFragment extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            View rootView = inflater.inflate(R.layout.fragment_manage_route,
                    container, false);
            return rootView;
        }
    }
    ...
    public void onBackPressed() {
        ...
        if(((RouteInfoFragment)currentFragment).getRouteSet()) {
    ...
    public void onPositiveClick(boolean isLocationSet) {
        ...
        ((RouteInfoFragment)currentFragment).cancelRoute();
        super.onBackPressed();
    }
